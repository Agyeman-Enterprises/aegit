...
import (
	...
	"code.aegit.io/aegit/modules/packages/alpine"
	"code.aegit.io/aegit/modules/packages/arch"
	"code.aegit.io/aegit/modules/packages/cargo"
	"code.aegit.io/aegit/modules/packages/chef"
	"code.aegit.io/aegit/modules/packages/composer"
	"code.aegit.io/aegit/modules/packages/conan"
	"code.aegit.io/aegit/modules/packages/conda"
	"code.aegit.io/aegit/modules/packages/container"
	"code.aegit.io/aegit/modules/packages/cran"
	"code.aegit.io/aegit/modules/packages/debian"
	"code.aegit.io/aegit/modules/packages/helm"
	"code.aegit.io/aegit/modules/packages/maven"
	"code.aegit.io/aegit/modules/packages/npm"
	"code.aegit.io/aegit/modules/packages/nuget"
	"code.aegit.io/aegit/modules/packages/pub"
	"code.aegit.io/aegit/modules/packages/pypi"
	"code.aegit.io/aegit/modules/packages/rpm"
	"code.aegit.io/aegit/modules/packages/rubygems"
	"code.aegit.io/aegit/modules/packages/swift"
	"code.aegit.io/aegit/modules/packages/vagrant"
