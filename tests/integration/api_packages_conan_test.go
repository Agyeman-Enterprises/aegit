...
import (
	...
	conan_model "code.aegit.io/aegit/models/packages/conan"
	"code.aegit.io/aegit/models/unittest"
	user_model "code.aegit.io/aegit/models/user"
	conan_module "code.aegit.io/aegit/modules/packages/conan"
	"code.aegit.io/aegit/modules/setting"
	conan_router "code.aegit.io/aegit/routers/api/packages/conan"
	package_service "code.aegit.io/aegit/services/packages"
