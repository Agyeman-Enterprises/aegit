...
import (
	...
	"code.aegit.io/aegit/routers/api/v1/activitypub"
	"code.aegit.io/aegit/routers/api/v1/admin"
	"code.aegit.io/aegit/routers/api/v1/misc"
	"code.aegit.io/aegit/routers/api/v1/notify"
	"code.aegit.io/aegit/routers/api/v1/org"
	"code.aegit.io/aegit/routers/api/v1/packages"
	"code.aegit.io/aegit/routers/api/v1/repo"
	"code.aegit.io/aegit/routers/api/v1/settings"
	"code.aegit.io/aegit/routers/api/v1/user"
	...
	_ "code.aegit.io/aegit/routers/api/v1/swagger" // for swagger generation
