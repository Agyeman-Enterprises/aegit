...
import (
	...
	"code.aegit.io/aegit/routers/api/packages/alpine"
	"code.aegit.io/aegit/routers/api/packages/arch"
	"code.aegit.io/aegit/routers/api/packages/cargo"
	"code.aegit.io/aegit/routers/api/packages/chef"
	"code.aegit.io/aegit/routers/api/packages/composer"
	"code.aegit.io/aegit/routers/api/packages/conan"
	"code.aegit.io/aegit/routers/api/packages/conda"
	"code.aegit.io/aegit/routers/api/packages/container"
	"code.aegit.io/aegit/routers/api/packages/cran"
	"code.aegit.io/aegit/routers/api/packages/debian"
	"code.aegit.io/aegit/routers/api/packages/generic"
	"code.aegit.io/aegit/routers/api/packages/goproxy"
	"code.aegit.io/aegit/routers/api/packages/helm"
	"code.aegit.io/aegit/routers/api/packages/maven"
	"code.aegit.io/aegit/routers/api/packages/npm"
	"code.aegit.io/aegit/routers/api/packages/nuget"
	"code.aegit.io/aegit/routers/api/packages/pub"
	"code.aegit.io/aegit/routers/api/packages/pypi"
	"code.aegit.io/aegit/routers/api/packages/rpm"
	"code.aegit.io/aegit/routers/api/packages/rubygems"
	"code.aegit.io/aegit/routers/api/packages/swift"
	"code.aegit.io/aegit/routers/api/packages/terraform"
	"code.aegit.io/aegit/routers/api/packages/vagrant"
